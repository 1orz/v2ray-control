...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/v2ray/v2ray-core/releases/download/v4.23.4/v2ray-linux-64.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/githubphone/pay-v2ray-sspanel-v3-mod_Uim-plugin/releases/latest"
